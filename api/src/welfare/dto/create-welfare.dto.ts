...
export const CreateWelfareSchema = z.object({
    ...
    categoryID: z.array(z.number().int().positive(), { message: 'Category IDs must be an array of positive integers' }),
    identityID: z.array(z.number().int().positive(), { message: 'Identity IDs must be an array of positive integers' }),
});
